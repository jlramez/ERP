    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                {{ Form::text('solicitados', $addproduct->solicitados, ['class' => 'form-control' . ($errors->has('solicitados') ? ' is-invalid' : ''), 'placeholder' => 'Solicitados']) }}
                {!! $errors->first('solicitados', '<div class="invalid-feedback">:message</div>') !!}
            </div>
            <div class="form-group col-sm-6">
                {{ Form::label('transferidos') }}
                {{ Form::text('transferidos', $addproduct->transferidos, ['class' => 'form-control' . ($errors->has('transferidos') ? ' is-invalid' : ''), 'readonly' => 'true','placeholder' => 'Transferidos']) }}
