...
class PedidoController extends Controller
{
    ...
    {
        return Excel::download(new UsersExport, 'pedidos.xls');
    }
    public function index()
    {
        ...
        return view('pedido.index', compact('pedidos','proveedores'))
    ...
    public function create()
    {
        $pedido = new Pedido();
        $proveedores= Proveedore::paginate();
        return view('pedido.create', compact('pedido','proveedores'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pedido.edit', compact('pedido','proveedores'));
    }
